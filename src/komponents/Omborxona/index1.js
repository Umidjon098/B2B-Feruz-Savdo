    ...
    return (
        <>
            ...
            <div style={{width: "100%",textAlign: "center"}}>
                ...
                <SearchOmborxona>
                    <SearchWrapper>
                        <SearchInput onChange={(event) => {serName(event.target.value)}} placeholder="nomi"/>
                        <div style={{position: "relative"}}>
                            <SearchInput
                                ...
                                placeholder="..dan"
                                value={inputValue2}
                                onFocus={() => {console.log("fokus event")}}
                        ...
                        <SearchInput onChange={(event) => {setEnd_quantity(event.target.value)}} placeholder="..gacha"/>
